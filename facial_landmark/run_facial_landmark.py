...
def main():
    # ============================================================
    # Load the 4 required input variables
    # ============================================================
    IMG_PATH = '/kaggle/input/datasets/lctrnnguynkhi/facial-material/portrait.jpg'
    ROTATED_IMG_PATH = '/kaggle/input/datasets/lctrnnguynkhi/facial-material/portrait_70_left.png'
    MASK_PATH = '/kaggle/input/datasets/cymeu4l0t/mask-set/half_face_mask.jpg'
    BISENET_WEIGHT_PATH = '/kaggle/input/datasets/lctrnnguynkhi/bisenet-checkpoint/79999_iter.pth'
