...
image = Image.open('/kaggle/input/datasets/cymeu4l0t/project-images/portrait.jpg')
plt.imshow(image)
...
mv_images, pos_images, normal_images, ref_image = run_pipeline(
        mv_adapter_pipe,
        mesh_path = '/kaggle/input/datasets/cymeu4l0t/3d-portrait/output.glb',
        num_views=NUM_VIEWS,
        text="high quality",
        image=image,
        height=HEIGHT,
